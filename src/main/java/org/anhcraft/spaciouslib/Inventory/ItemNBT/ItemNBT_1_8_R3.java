 ...
 */
public class ItemNBT_1_8_R3 implements ItemNBTWarpper {
    private ItemStack item;
    private net.minecraft.server.v1_8_R3.ItemStack nmsItem;
    private NBTTagCompound compound;

    public ItemNBT_1_8_R3(ItemStack i){
        item = i;
    ...
    public ItemNBT_1_8_R3(ItemStack i, String cp){
        item = i;
        nmsItem = CraftItemStack.asNMSCopy(i);
        NBTTagCompound c = nmsItem.getTag();
    ...
    public ItemNBTWarpper getCompound(String name) {
        return new ItemNBT_1_8_R3(item, name);
    }
}
