 ...
 */
public class ItemNBT_1_10_R1 implements ItemNBTWarpper {
    private ItemStack item;
    private net.minecraft.server.v1_10_R1.ItemStack nmsItem;
    private NBTTagCompound compound;

    public ItemNBT_1_10_R1(ItemStack i){
        item = i;
    ...
    public ItemNBT_1_10_R1(ItemStack i, String cp){
        item = i;
        nmsItem = CraftItemStack.asNMSCopy(i);
        NBTTagCompound c = nmsItem.getTag();
    ...
    public HashMap<String, Byte> getAllTags() {
        ...
        for(String s : compound.c()){
            h.put(s, compound.get(s).getTypeId());
        }
        return h;
    }
    ...
    public ItemNBTWarpper getCompound(String name) {
        return new ItemNBT_1_10_R1(item, name);
    }
}
