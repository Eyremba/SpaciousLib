 ...
 */
public class ItemNBT_1_9_R2 implements ItemNBTWarpper {
    private ItemStack item;
    private net.minecraft.server.v1_9_R2.ItemStack nmsItem;
    private NBTTagCompound compound;

    public ItemNBT_1_9_R2(ItemStack i){
        item = i;
    ...
    public ItemNBT_1_9_R2(ItemStack i, String cp){
        item = i;
        nmsItem = CraftItemStack.asNMSCopy(i);
        NBTTagCompound c = nmsItem.getTag();
    ...
    public ItemNBTWarpper getCompound(String name) {
        return new ItemNBT_1_9_R2(item, name);
    }
}
